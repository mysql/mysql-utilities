...
class test(rpl_admin.test):
    ...
    def do_masks(self):
        self.replace_substring(str(self.server1.port), "PORTX")
        self.replace_substring(str(self.server2.port), "PORTX")
        self.replace_substring(str(self.server3.port), "PORTX")
