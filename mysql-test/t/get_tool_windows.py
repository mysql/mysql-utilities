...
class test(mutlib.System_test):
    ...
    def check_prerequisites(self):
        ...
        if fail or self.old_server is None:
            raise MUTLibError("Test requires one server version prior to "
                              "5.1.21 and Windows OS")
    ...
    def run(self):
        ...
        num_test = 1
        comment = "Test case {0} - get_tool mysqld-nt.exe \n".format(num_test)
