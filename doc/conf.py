# -*- coding: utf-8 -*-
#
# MySQL Utilities documentation build configuration file, created by
...
copyright = mysql.utilities.COPYRIGHT
...
release = mysql.utilities.RELEASE_STRING
...
htmlhelp_basename = 'MySQLUtilitiesdoc'
...
latex_documents = [
  ('index', 'MySQLUtilities.tex', u'MySQL Utilities Documentation',
   u'MySQL Utilities Team', 'manual'),
]
...
man_pages = [
    ('man/mysqldbcompare', 'mysqldbcompare',
     u'check two databases and identify any differences',
    ...
    ('man/mysqldbimport', 'mysqldbimport',
     ...
     [u'MySQL Utilities Team'], 1),
    ('man/mysqldiff', 'mysqldiff',
     u'Identify differences among database objects',
     [u'MySQL Utilities Team'], 1),
    ('man/mysqldiskusage', 'mysqldiskusage',
     u'Show disk usage for one or more databases',
     [u'MySQL Utilities Team'], 1),
    ('man/mysqlfailover', 'mysqlfailover',
     u'Automatic replication health monitoring and failover',
     [u'MySQL Utilities Team'], 1),
    ...
    ('man/mysqlreplicate', 'mysqlreplicate',
     ...
     [u'MySQL Utilities Team'], 1),
    ('man/mysqlrpladmin', 'mysqlrpladmin',
     u'Administration utility for MySQL replication',
     [u'MySQL Utilities Team'], 1),
    ('man/mysqlrplcheck', 'mysqlrplcheck',
    ...
    ('man/mysqlserverclone', 'mysqlserverclone',
     ...
     [u'MySQL Utilities Team'], 1),
    ('man/mysqlserverinfo', 'mysqlserverinfo',
     u'Display common diagnostic information from a server',
     [u'MySQL Utilities Team'], 1),
    ('man/mysqluc', 'mysqluc',
     u'Command line client for running MySQL Utilities',
     [u'MySQL Utilities Team'], 1),
    ('man/mysqluserclone', 'mysqluserclone',
     u'Copy a MySQL user to one or more new users on another server',
     [u'MySQL Utilities Team'], 1),
    ('man/mysqlauditadmin', 'mysqlauditadmin',
     u'Administration utility for the Audit Log plugin',
     [u'MySQL Utilities Team'], 1),
...
epub_title = u'MySQL Utilities'
epub_author = u'MySQL Utilities Team'
epub_publisher = u'Oracle'
epub_copyright = mysql.utilities.COPYRIGHT
